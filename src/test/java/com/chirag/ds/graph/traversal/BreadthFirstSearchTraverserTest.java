...
import com.chirag.ds.graph.traversal.BreadthFirstSearchTraverser;
...
public class BreadthFirstSearchTraverserTest {
	...
	public void testTraversalForUndirectedGraph() {
		...
		BreadthFirstSearchTraverser<Integer> traverser = new BreadthFirstSearchTraverser<>(graph, node2);
